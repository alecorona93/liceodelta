...
namespace Alumnos
{
    public partial class recibosateneo : Form
    {
        public recibosateneo()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand instruccion = new SqlCommand("Select * FROM Recibosateneo WHERE nocuenta LIKE @nocuenta +'%'", Conexion);
            ...
            MessageBox.Show("Esto es lo que encontre");
            Conexion.Close();
        ...
        {
            SqlConnection Conexion = new SqlConnection("Data Source=(localdb)\\projects;Initial Catalog=Tarea;Integrated Security=True");
            SqlCommand instruccion = new SqlCommand("Insert INTO Recibosateneo(nocuenta, lugar, fecha, recibi, cantidad, cantidadletra, concepto) VALUES (@nocuenta, @lugar, @fecha, @recibi, @cantidad, @cantidadletra, @concepto)", Conexion);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            crystalrpt.Load(@"C:\Users\Alejandro\Desktop\Liceo Delta\Alumnos\Alumnos\recibosateneos.rpt");
        ...
        {
            SqlConnection Conexion = new SqlConnection("Data Source=(localdb)\\projects;Initial Catalog=Tarea;Integrated Security=True");
            SqlCommand instruccion = new SqlCommand("UPDATE Recibosateneo SET lugar=@lugar, fecha=@fecha, recibi=@recibi, cantidad=@cantidad, cantidadletra=@cantidadletra, concepto=@concepto where nocuenta=@nocuenta", Conexion);
            instruccion.Parameters.AddWithValue("@lugar", txtlugar.Text);
            instruccion.Parameters.AddWithValue("@fecha", dateTimePicker1.Text);
            instruccion.Parameters.AddWithValue("@recibi", txtrecibi.Text);
            instruccion.Parameters.AddWithValue("@cantidad", txtcantidad.Text);
