...
namespace Alumnos
{
    public partial class Listas : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand instruccion = new SqlCommand("Select * FROM InscriLiceo WHERE ciclo LIKE @ciclo +'%' AND año LIKE @año +'%' AND semestre LIKE @semestre +'%' AND grupo LIKE @grupo +'%' ORDER BY apellidopaterno ASC", Conexion);
            instruccion.Parameters.AddWithValue("@ciclo", cboxciclo.Text);
            instruccion.Parameters.AddWithValue("@año", txtaño.Text);
            ...
            while (Lector.Read())
            {
                ...
                temporal.Text=(Lector["apellidopaterno"].ToString()+ " " +Lector["apellidomaterno"].ToString()+ " "+Lector["nombres"].ToString());
                TextBox temporal2 = (TextBox)Controls["txtno"+p.ToString()];
                temporal2.Text = p.ToString();
                p++;
               }
            MessageBox.Show("Lista generada con alumnos inscritos");
            Conexion.Close();
        }
        ...
        private void btnimprimir_Click(object sender, EventArgs e)
        {
            ...
            crystalrpt.Load(@"C:\Users\Alejandro\Desktop\Liceo Delta\Alumnos\Alumnos\CrystalReport7.rpt");
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            //Creamos el objeto qe apuntara al reporte de crystal en mi caso CrystalReport1.rpt
            ReportDocument crystalrpt = new ReportDocument();
            crystalrpt.Load(@"C:\Users\Alejandro\Desktop\Liceo Delta\Alumnos\Alumnos\CrystalReport6.rpt");
